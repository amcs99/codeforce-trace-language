  ...
  try {
    ...
    for (let i = 1; i < table.childElementCount; ++i) {
      ...
      if (usedLanguageWeNeed) {
        const content = `${userName} (latest submission with ${LANGUAGE}: https://codeforces.com/contest/${contestId}/submission/${submissionId})`;
        fs.appendFileSync('list_user.txt', content + '\n');
      }
